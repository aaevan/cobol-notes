      ...
      * --------- original: ---------
      * compiler complained when we tried to index something with
      * an 01 level.
      * -----------------------------
      ...
      * --------- modified: ---------
      * bumped table-state-record in a level so that it plays nicely
      * with a modern compiler?? I might be missing something here.
      * -----------------------------
       01 TABLE-STATE-RECORD-OUTER.
